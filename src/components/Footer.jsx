...
const Footer = () => {
    return (
        <footer className="footer">
            <div className="site-container" style={{display:'flex',flexDirection:'column',gap:10,padding:'12px 0',alignItems:'center',textAlign:'center'}}>
                ...
                <div>
                    ...
                    <p className="small" style={{marginTop:6}}>Get inventory drops and shop updates in your inbox.</p>
                    <form style={{marginTop:6,display:'flex',gap:8,flexWrap:'wrap'}}>
            ...
            <div style={{borderTop:'1px solid rgba(255,255,255,0.04)'}}>
                <div className="site-container" style={{padding:'6px 0',textAlign:'center'}}>
